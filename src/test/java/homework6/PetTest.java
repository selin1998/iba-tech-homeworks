...
class PetTest {
    ...
    @BeforeEach
    void setUp() {
        this.pet = new Pet(Species.DOG, "Tuzik", 7, 70, new String[]{"barking", "rolling the tail", "standing on two legs"});
        this.newPet = new Pet(Species.DOG, "Tuzik", 7, 40, new String[]{"eating ice-cream"});
        this.otherPet = new Pet(Species.FISH, "Tuzik");
    }
