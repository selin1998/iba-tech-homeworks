...
import homework9.entity.human.Woman;
import homework9.entity.pet.Dog;
import homework9.entity.pet.DomesticCat;
import homework9.entity.pet.Pet;
import homework9.entity.pet.RoboCat;
...
class FamilyServiceTest {
    ...
    void deleteAllChildrenOlderThan() {
        ...
        fs.deleteAllChildrenOlderThan(18, 1919);
        assertFalse(familyList.get(0).getChildren().contains(curie3));
        assertTrue(familyList.get(0).getChildren().contains(curie4));
